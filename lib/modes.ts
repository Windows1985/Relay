...
export const MODE_COPY: Record<string, { title: string; hint: string }> = {
  ...
  hold_button: { title: "Hold it", hint: "Hold the button down for exactly 8 seconds. No counting out loud." },
  memory: { title: "Memory", hint: "Watch the pattern, then repeat it. It gets one longer every time." },
  blue_thing: { title: "Something blue", hint: "Find something blue. Best one wins." },
  oldest_thing: { title: "Oldest thing you own", hint: "The oldest thing within reach. Prove it." },
  your_view: { title: "Your view", hint: "Whatever you can see right now. No tidying up." },
  worst_advice: { title: "Worst advice", hint: "The worse it is, the better." },
  hot_take: { title: "Hot take", hint: "Say the indefensible thing." },
